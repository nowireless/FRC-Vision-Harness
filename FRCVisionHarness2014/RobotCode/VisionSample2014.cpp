...
//public:
	 ...
	 */
	void VisionSample2014::Autonomous(const char* file)
	{
		Scores *scores;
		TargetReport target;
	 ...
	 */
	void VisionSample2014::OperatorControl(void)
	{
	...
	double VisionSample2014::computeDistance (BinaryImage *image, ParticleAnalysisReport *report) {
		...
		double min1 = report->boundingRect.height;
		double min2 = rectLong;
		//height = min(report->boundingRect.height, rectLong);
		height = min(min1, min2);
		targetHeight = 32;
